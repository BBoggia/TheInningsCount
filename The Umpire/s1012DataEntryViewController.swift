...
class s1012DataEntryViewController: UIViewController, UITextFieldDelegate {
    ...
    func sendData() {
        ...
        FIRDatabase.database().reference().child("Database").child("softball1012").child(teamName).child("\(self.databaseDate)").setValue("\(userDate) | Player#: \(playerNumberTextField.text!) | Innings Pitched: \(pitchCountTextField.text!)")
    }
